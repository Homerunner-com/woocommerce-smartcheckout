...
<?php if(get_option('csc_token') != ''): ?>
    <div class="csc-settings-boxes">
        <div>
            <a href="https://account.homerunner.com/"><?php echo __('Opret leveringsprodukter', 'csc_textdomain'); ?></a><br>
...
<div class="csc-settings-boxes">
    <div>
        ...
        Har du spørgsmål omkring opsætningen eller omkring HomeRunners produkter, så kan du altid kontakte os.
    </div>
</div>
